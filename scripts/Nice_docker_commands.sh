...
docker run -e PORT=5000 -p 5000:5000 eu.gcr.io/$PROJECT_ID/$DOCKER_IMAGE_NAME
...
export PROJECT_ID='omega-clarity-337815'
export DOCKER_IMAGE_NAME=mushroom-frontend

docker build ... --output /dev/shm



## Note for a smaller image you should use the alpine python env in your dockerfile.
